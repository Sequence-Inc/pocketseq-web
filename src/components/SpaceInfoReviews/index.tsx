...
const reviewComment: IReviewComment[] = [
    ...
    },
    {
        name: "Takayuki",
        date: "2021年5月",
        comment: "施設はとても綺麗で､ｷｯﾁﾝやｱﾒﾆﾃｨも充実しています｡ ｿﾌﾄﾊﾞﾝｸ携帯の電波が入らない点が難点でしたが､滞在はとても満足しています｡!",
        thumbnail: "/review.jpg"
    },
    {
        name: "Yusaku",
    ...
    },
    {
        name: "高橋",
        date: "2021年5月",
        comment: "非常に満足です｡ 対応も設備も文句なし｡ 素晴らしい非日常を味わうことができました｡ 何も不自由することなく楽しめましたので 是非利用してみてください｡!",
        thumbnail: "/review.jpg"
    },
];
    ...
    return (
        <div>
            <div className="flex items-center space-x-2">
                ...
                <p className="text-lg font-bold text-gray-700">4.52（99件のレビュー）</p>
            </div>
