...
export const HeroSection = () => {
    return (
        <div className={clsx(
            "relative w-full mt-16 md:mt-0 aspect-w-1 aspect-h-1",
            ...
            <Container className="absolute top-0 left-0 z-10 md:pt-16">
                <div className="flex flex-col items-center justify-center w-full h-full lg:items-start lg:w-7/12 xl:w-1/2">
                    <p className="mb-5 text-2xl text-center text-white sm:text-4xl lg:text-left">貸切のレンタルスペースで"やってみたい"を叶えよう</p>
                    <p className="mb-12 text-center text-white text-md sm:text-xl lg:text-left">15,287件のスペースから、目的に合ったスペースがすぐ見つかる</p>
                    <SearchBox />
                </div>
            </Container>
        </div>
