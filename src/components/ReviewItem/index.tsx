...
export const ReviewItem = ({
    ...
    return (
        <div className={`grid grid-cols-5 ${className && className}`}>
            <div className="col-span-3 text-gray-800">{title}</div>
            <div className="flex items-center col-span-2 space-x-2">
                <div id={id} className="relative w-20">
                    <div className="flex h-1 overflow-hidden text-xs bg-gray-200 rounded">
                        <div
                ...
                <label htmlFor={id} className="text-xs font-bold text-gray-800">
                    {value}
                </label>
            </div>
        </div>
