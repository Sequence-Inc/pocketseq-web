        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            <div className="grid grid-cols-2 gap-8">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-md font-bold text-gray-200 tracking-wider uppercase">レンタルスペースを探す</h3>
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-md font-bold text-gray-200 tracking-wider uppercase">ご利用ガイド</h3>
                  <ul className="mt-4 space-y-4">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-md font-bold text-gray-200 tracking-wider uppercase">スペースマーケットについて</h3>
                  <ul className="mt-4 space-y-4">
                ...
                <div className="mt-12 md:mt-0 flex justify-center">
                    <div>
                <h2 className="text-lg font-semibold text-gray-400 tracking-wider uppercase">Time Book</h2>
