                ...
                <form action="#" method="POST">
                    <div className="shadow sm:rounded-md sm:overflow-hidden">
                        <div className="px-4 py-6 space-y-6 bg-white sm:p-6">
                            <div>
                                <h3 className="text-lg font-medium leading-6 text-gray-900">Create new space</h3>
                                ...
                                <div className="col-span-3 sm:col-span-2">
                                    ...
                                    <div className="flex mt-1 rounded-md shadow-sm">
                                        ...
                                        <input
                                            ...
                                            className="flex-grow block w-full min-w-0 border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-r-md sm:text-sm"
                                        />
                                    </div>
                                </div>
                        ...
                        <div className="flex px-4 py-3 space-x-2 bg-gray-50 sm:px-6">
                            {/* <button
                                type="submit"
